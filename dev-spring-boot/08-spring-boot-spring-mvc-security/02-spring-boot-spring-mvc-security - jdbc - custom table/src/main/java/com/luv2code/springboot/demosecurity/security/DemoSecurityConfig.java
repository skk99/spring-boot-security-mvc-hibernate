...
public class DemoSecurityConfig {
    ...
    public UserDetailsManager userDetailsManager(DataSource dataSource) {
        ...
        // Tell spring security to use JDBC authentication with our data source and custom schemas
    ...
    public UserDetailsManager userDetailsManager(DataSource dataSource) {
        ...
        // Tell spring security to use JDBC authentication with our data source and pre-defined schemas
